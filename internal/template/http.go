...
func GetHttpAuthenticationMiddlewareTemplate(application *dto.ApplicationDto) []byte {
	...
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tHeader string `mapstructure:\"HTTP_SERVER_AUTHENTICATION_TOKEN_HEADER\"`"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tToken string `mapstructure:\"HTTP_SERVER_AUTHENTICATION_TOKEN\"`"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("}"))
	data.WriteString(separator)
	data.WriteString(separator)
...
func GetHttpServerTemplate(application *dto.ApplicationDto) []byte {
	...
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tHostname string `mapstructure:\"HTTP_SERVER_HOSTNAME\"`"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tPort string `mapstructure:\"HTTP_SERVER_PORT\"`"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tAuthentication middleware.HttpAuthenticationConfig `mapstructure:\",squash\"`"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("}"))
	data.WriteString(separator)
	data.WriteString(separator)
