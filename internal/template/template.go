...
func GetHandlerRealisationTemplate(module string, kind string, layer string, name string) []byte {
	...
	data.WriteString(fmt.Sprintf("import ("))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\t\"%s/utils\"", module))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\t\"net/http\""))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tdefinition \"%s/%s/%s\"", module, kind, utils.Lowercase(layer)))
	...
	data.WriteString(fmt.Sprintf("func (%s *%s%s) %sHandle(response http.ResponseWriter, request *http.Request) {", utils.FirstLetter(name), utils.Capitalize(name), utils.Capitalize(layer), utils.Capitalize(name)))
	data.WriteString(separator)
...
func GetHttpServerTemplate(module string, name string) []byte {
	...
	data.WriteString(fmt.Sprintf("\t\"fmt\""))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\t\"%s/internal/handler\"", module))
	data.WriteString(separator)
