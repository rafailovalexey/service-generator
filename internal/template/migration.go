...
func GetMigrationTemplate(module string) []byte {
	data := bytes.Buffer{}
	...
	data.WriteString(fmt.Sprintf("func Run(db database.DatabaseInterface) {"))
	data.WriteString(separator)
	...
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\t\tlog.Panicf(\"specify the directory for migration\\n\")"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\t}"))
	data.WriteString(separator)
	data.WriteString(separator)
	...
	data.WriteString(separator)
	data.WriteString(fmt.Sprint("\t\tlog.Panicf(\"failed to connect %s\\n\", err.Error())"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\t}"))
	data.WriteString(separator)
	data.WriteString(separator)
	...
	data.WriteString(fmt.Sprintf("\tif err != nil {"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprint("\t\tlog.Panicf(\"migration failed %v\\n\", err)"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\t}"))
	data.WriteString(separator)
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tlog.Println(\"migrations applied successfully\")"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("}"))
	data.WriteString(separator)
