...
func GetDatabasePostgresTemplate() []byte {
	...
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tPort int `env:\"POSTGRES_PORT,required\"`"))
	data.WriteString(separator)
	...
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tConnectionMaxLifeTime int `env:\"POSTGRES_CONNECTION_MAX_LIFE_TIME,required\"`"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tConnectionMaxIdleTime int `env:\"POSTGRES_CONNECTION_MAX_IDLE_TIME,required\"`"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("}"))
	data.WriteString(separator)
	data.WriteString(separator)
...
func GetDatabaseMySqlTemplate() []byte {
	...
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tPort int `env:\"MYSQL_PORT,required\"`"))
	data.WriteString(separator)
	...
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tConnectionMaxLifeTime int `env:\"MYSQL_CONNECTION_MAX_LIFE_TIME,required\"`"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("\tConnectionMaxIdleTime int `env:\"MYSQL_CONNECTION_MAX_IDLE_TIME,required\"`"))
	data.WriteString(separator)
	data.WriteString(fmt.Sprintf("}"))
	data.WriteString(separator)
	data.WriteString(separator)
